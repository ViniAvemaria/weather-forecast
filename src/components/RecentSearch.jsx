...
import RecentSearchSkeleton from "./skeleton/RecentSearchSkeleton";
...
const RecentSearch = ({ cityId, index }) => {
    ...
    const Icon = weather ? iconMap[weather.weather?.[0]?.icon] : null;
        ...
        >
            <div className="flex justify-between gap-2 pr-2">
                <div className="flex flex-col gap-1 min-w-0">
                    ...
                    <h3 className="text-muted-text text-xs truncate">{countries.getName(weather.sys.country, "en")}</h3>
                </div>
